...
public class SandboxMapas
{
    ...
    {
    	if (mapaCadenas.values().size() != 0)
    	{
    		String primera = getLlavesComoListaInvertida().getLast();
            return primera;
    	}
    	else
    	{
    ...
    public String getUltima( )
    {
    	if (mapaCadenas.values().size() != 0)
    	{
    		String ultima = getLlavesComoListaInvertida().getFirst();
            return ultima;
    	}
    	else
    	{
    ...
    {
    	List<String> listaKeys = getLlavesComoListaInvertida();
    	Collection<String> listaUp = new ArrayList<String>();
    	for (int i = 0; i < listaKeys.size(); i++)
    	{
    		String a = listaKeys.get(i).toUpperCase();
    		listaUp.add(a);
    	}
        return listaUp;
    }
    ...
    {
    	int cantidad = mapaCadenas.values().size();
        return cantidad;
    }
    ...
    public void volverMayusculas( )
    {
    	...
    	for (Map.Entry<String, String> i : mapaCadenas.entrySet()) 
    	{
            ...
            mapa.put(clave.toUpperCase(), valor);
        }
    	mapaCadenas.clear();
    	mapaCadenas = mapa;
    }
